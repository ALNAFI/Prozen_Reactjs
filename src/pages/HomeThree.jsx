...
export default function HomeThree() {
  return (
    <>
          ...
          <div className="container-fluid">
            <div className="ht-menu-wrapper">
              ...
              <div className="ht-menu-right">
                    ...
                    <ul>
                      <li className="has-dropdown">
                        ...
                        <ul className="sub-menu">
                          ...
                          <li>
                            <a href="index-2.html">Corporate Business</a>
                          </li>
                          <li>
                            <a href="index-3.html">Insurance</a>
                          </li>
                        </ul>
                      </li>
                      <li>
                ...
                <a href="contact.html" className="ht-btn d-none d-lg-block">
                  get in touch
                </a>
          ...
          <div className="hero-wrapper">
            <div className="ht-hero-content style-3">
              ...
              <p className="desc wow fadeInUp" data-wow-delay=".6s">
                Explore our tailored insurance solutions and experience the
        ...
        <div className="container">
          <div className="section-title text-center">
            ...
            <h2 className="title wow fadeInUp" data-wow-delay=".5s">
              We're Covering All the <br /> Insurance Services{" "}
            </h2>
          </div>
            ...
            <div className="row">
              ...
              >
                <div className="ht-services-items mt-25">
                  ...
                  <p className="desc">
                    With our innovative consulting today's breakthroughs become
                    the leadership strategies propelling your
                  </p>
                  <a href="service-details.html" className="link">
      ...
      {/* ht-services-3-area-end */}

      {/* ht-about-3-area-start */}
            ...
            <div className="row align-items-lg-center gy-5 gy-lg-0">
              <div className="col-lg-6 col-sm-12">
                <div className="ht-about-img wow fadeInUp" data-wow-delay=".3s">
                  <img src="images/about/3.jpg" alt="img" />
                </div>
              </div>
              <div className="col-lg-6 col-sm-12">
                <div className="ht-about-content style-2">
                  <div className="section-title">
                    ...
                    <p className="wow fadeInUp" data-wow-delay=".8s">
                      ...
                      Your success is our shared triumph, and we're unwavering
      ...
      <div className="section ht-process-area-3">
        <div className="container">
          <div className="section-title text-center">
            ...
            <h2 className="title wow fadeInUp" data-wow-delay=".5s">
              Easy process to find <br /> your ideal plan
            </h2>
          </div>
            ...
            <div className="row gy-5 justify-content-between">
              ...
              >
                <div className="process-item">
                  <div className="thumb">
                    <img src="images/process/1.jpg" alt="process-img" />
                    <div className="circle">
                      <img src="images/shape/9.svg" alt="circle" />
                    </div>
                    <span>1</span>
                    <div className="step-arrow">
                      <img src="images/icon/6.svg" alt="arrow-icon" />
                    </div>
                  </div>
                  <div className="contents">
                    ...
                    <p>
                      ...
                      that awesome revenue superior scenarios.
                    </p>
                  </div>
                </div>
              </div>
              ...
              >
                <div className="process-item">
                  <div className="thumb">
                    <img src="images/process/2.jpg" alt="process-img" />
                    <div className="circle">
                      <img src="images/shape/9.svg" alt="circle" />
                    </div>
                    <span className="nth">2</span>
                    <div className="step-arrow">
                      <img src="images/icon/7.svg" alt="arrow-icon" />
                    </div>
                  </div>
                  <div className="contents">
                    <h3>Get a Quote</h3>
              ...
              >
                <div className="process-item">
                  <div className="thumb">
                    <img src="images/process/3.jpg" alt="process-img" />
                    <div className="circle">
                      <img src="images/shape/9.svg" alt="circle" />
                    </div>
                    <span>3</span>
            ...
            <div className="row">
                ...
                <div className="ht-price-content">
                  <div className="section-title">
                    ...
                    <p className="wow fadeInUp" data-wow-delay=".6s">
                      Our coaching packages are designed to meet diverse needs
                      and budgets, providing flexibility for every individual
                      and organization. Whether you're seeking personal.
                    </p>
                  </div>
                  <a
                    href="pricing.html"
              ...
              <div className="col-lg-6">
                <div className="ht-price-item">
                  ...
                  >
                    ...
                    <div className="right">
                      <ul className="price-details">
                        <li>
                          <i className="fa-solid fa-check"></i>Initial
                          consultation
                        </li>
                        <li>
                        ...
                        <li>
                          <i className="fa-solid fa-check"></i>Online resources
                        </li>
                        <li>
                          <i className="fa-solid fa-check"></i>Flexible
                          scheduling
                        </li>
                        <li>
                          <i className="fa-solid fa-check"></i>Tracking sheets
                        </li>
                        <li>
                          <i className="fa-solid fa-check"></i>Private client
                          portal
                        </li>
                      </ul>
                    </div>
                  ...
                  <div
                    className="single-item style-2 wow fadeInUp"
                    data-wow-delay=".6s"
                  >
                    <div className="left">
                      <span>Basic Package</span>
      ...
      {/* ht testimonials 3 area start */}
      <section className="ht-testimonials-area-2 section-padding fix">
        <div className="bg-shape">
          <img src="images/shape/8.svg" alt="shape" />
        </div>
        <div className="container">
                  ...
                  <div className="swiper-wrapper">
                    <div className="swiper-slide">
                      <div className="testimonial-slides-item">
                        ...
                        <p>
                          “It’s a pleasure working with Bunker our new brand
                          positioning guidelines and translated them beautifully
                          and consistently into our on-going marketing comms”
                        </p>
                        <div className="info">
            ...
            <div className="row gy-5">
              <div className="col-xl-6 col-lg-6">
                <div className="ht-faq-thumb wow fadeInUp" data-wow-delay=".3s">
                  <img src="images/faq/1.jpg" alt="thumb" />
                </div>
              </div>
                ...
                <div className="ht-faq-content">
                  <div className="section-title">
                    ...
                    <p className="wow fadeInUp" data-wow-delay=".9s">
                      ...
                      florai psum dolor sit amet, amet consecteture.
                    </p>
                  </div>
                  <div className="accordion" id="faqAccordion">
                    ...
                    >
                      ...
                      >
                        <div className="accordion-body">
                          If you ask our clients what it’s like working 36,
                          they’ll about how much we care about their success.
                        </div>
                      </div>
                    </div>
                    <div
                    ...
                    >
                      ...
                      >
                        <div className="accordion-body">
                          Life insurance can provide financial security and
                    ...
                    >
                      ...
                      >
                        <div className="accordion-body">
                          Common business insurances include general liability,
            ...
            <div className="row gy-5">
              <div className="col-lg-5">
                <div className="ht-blog-contents">
                  ...
                  <a href="blog.html" className="ht-btn style-2">
                    view all blogs
                  </a>
                </div>
              </div>
              <div className="col-lg-7">
                <div className="ht-blog-item-wrapper">
                  ...
                  >
                    <div className="thumb">
                      <a href="blog-details.html">
                        <img src="images/blog/10.jpg" alt="blog-thumb" />
                      </a>
                    </div>
                    <div className="content">
                      ...
                      <a href="blog-details.html">
                        <h3>
                          Travel insurance tips for <br /> safety abroad
                        </h3>
                      </a>
                      <a href="blog-details" className="link">
                        read more
                      </a>
                    </div>
                  </div>
                  ...
                  >
                    <div className="thumb">
                      <a href="blog-details.html">
                        <img src="images/blog/11.jpg" alt="blog-thumb" />
                      </a>
                    </div>
                    <div className="content">
                      <span className="meta">June 16, 2024 | Business</span>
                      <a href="blog-details">
                        <h3>
                          Back-to-school coverage <br /> tips for kids.
                        </h3>
                      </a>
                  ...
                  >
                    <div className="thumb">
                      <a href="blog-details.html">
                        <img src="images/blog/12.jpg" alt="blog-thumb" />
                      </a>
                    </div>
                    <div className="content">
                      <span className="meta">June 16, 2024 | Business</span>
                      <a href="blog-details">
                        <h3>
                          Tips for handling a car <br /> accident scene.
                        </h3>
                      </a>
                      <a href="blog-details.html" className="link">
                        read more
            ...
            <div className="row gy-5">
              <div className="col-xl-5 col-lg-6">
                <div className="ht-footer-info">
                  ...
                  <p className="desc">
                    ...
                    leaflets approach each other and the flowers <br /> close
                    and droop, or are covered.
                  </p>
              ...
              <div className="col-xl-7 col-lg-6">
                <div className="content">
                  ...
                  <a href="contact.html" className="ht-btn style-2">
                    Get Updates
                  </a>
                </div>
              </div>
